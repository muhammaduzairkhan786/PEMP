...
| `prototype/index.html` | Self-contained **clickable prototype** of the hero screens: My-Turn home, Universal Engagement view + glowing spine, the SoW **gate ceremony** (attest → re-auth → optimistic commit → spine unlock), and the live register. Open in any browser; toggle theme; click *Review & Sign SoW* to play the ceremony. |
